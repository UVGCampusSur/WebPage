...
$oEmail = new imEMail(($imForceSender ? $_POST["Itm_8_00_5"] : "educacion@campussur.uvg.edu.gt"),"educacion@campussur.uvg.edu.gt","Formulario de becas en linea","iso-8859-1");
...
$oEmail = new imEMail("educacion@campussur.uvg.edu.gt",$_POST["Itm_8_00_5"],"Re: Formulario de becas en linea","iso-8859-1");
$oEmail->setText($txtMsg . "\r\n\r\n" . $txtData);
