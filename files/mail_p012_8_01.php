...
$oEmail = new imEMail(($imForceSender ? $_POST["Itm_8_01_2"] : "soporte@proesur.uvg.edu.gt"),"soporte@proesur.uvg.edu.gt","Solicitud de servicios en línea","iso-8859-1");
...
//Send email to user
$txtMsg = "Gracias por su información en breve será atendida,\r\n\r\nEdgar Amaya\r\nsoporte@proesur.uvg.edu.gt";
$htmMsg = $htmHead . "<tr><td>Gracias por su información en breve será atendida,<br><br>Edgar Amaya<br>soporte@proesur.uvg.edu.gt</td></tr>" . $htmFoot;
$oEmail = new imEMail("soporte@proesur.uvg.edu.gt",$_POST["Itm_8_01_2"],"Re: Confirmación de solicitud","iso-8859-1");
$oEmail->setText($txtMsg . "\r\n\r\n" . $txtData);
