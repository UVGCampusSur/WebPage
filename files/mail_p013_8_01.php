...
$txtData .= "Descripción del trabajo: " . $_POST["Itm_8_01_3"] . "\r\n";
$htmData .= "<tr><td width=\"25%\"><b>Descripción del trabajo:</b></td><td>" . $_POST["Itm_8_01_3"] . "</td></tr>";
...
$oEmail = new imEMail(($imForceSender ? $_POST["Itm_8_01_2"] : "servicios@proesur.uvg.edu.gt"),"servicios@proesur.uvg.edu.gt","Solicitud de servicios en línea","iso-8859-1");
...
//Send email to user
$txtMsg = "Gracias por su información en breve será atendidad,\r\n\r\nRené Buc Morales\r\nservicios@proesur.uvg.edu.gt";
$htmMsg = $htmHead . "<tr><td>Gracias por su información en breve será atendidad,<br><br>René Buc Morales<br>servicios@proesur.uvg.edu.gt</td></tr>" . $htmFoot;
$oEmail = new imEMail("servicios@proesur.uvg.edu.gt",$_POST["Itm_8_01_2"],"Re: Confirmación de solicitud","iso-8859-1");
$oEmail->setText($txtMsg . "\r\n\r\n" . $txtData);
